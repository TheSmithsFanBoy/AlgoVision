 ...
 @override
                       ...
                       return TextButton(style: TextButton.styleFrom(
                        ...
                        backgroundColor: Colors.indigo,fixedSize: const Size(30, 30),),
                          ...
                          onPressed: () 
                          {
                            ...
                            if (args.id == '5CxnC5paQ3yD1a6Tjmek') {  //! QUIZ IF
                              ...
                              var usuarioActual = FirebaseFirestore.instance.collection('users').doc(FirebaseAuth.instance.currentUser?.uid ?? 'null');
                                ...
                                if (value.docs.isNotEmpty) {
                                  ...
                                  var challenge = value.docs[7]; //! cambiar la pos de quiz iff
                            ...
                            if (args.id == 'xY7NyrKany1KgNWPPLAd') { //! FOR
                              var challengesLessonDone = FirebaseFirestore.instance.collection('challenges').get();
                              var usuarioActual = FirebaseFirestore.instance.collection('users').doc(FirebaseAuth.instance.currentUser?.uid ?? 'null');
                            ...
                            if (args.id == 'dRwf6L9K6fnECtvU61rC') { //! QUIZ WHILE
                              var challengesLessonDone = FirebaseFirestore.instance.collection('challenges').get();
                              var usuarioActual = FirebaseFirestore.instance.collection('users').doc(FirebaseAuth.instance.currentUser?.uid ?? 'null');
                            ...
                            if (args.id == 'NImip38OyNN166ISaFhK') {  //!KH99JvRZ9MOAo8DnnfLH - burbuja
                              ...
                              var usuarioActual = FirebaseFirestore.instance.collection('users').doc(FirebaseAuth.instance.currentUser?.uid ?? 'null');
                                ...
                                if (value.docs.isNotEmpty) {
                                  ...
                                  var challenge2 = value.docs[6];
                                  FirebaseFirestore.instance.collection('challenges').doc(challenge.id).update({'lessonDone':FieldValue.arrayUnion([usuarioActual])});
                                  FirebaseFirestore.instance.collection('challenges').doc(challenge2.id).update({'lessonDone':FieldValue.arrayUnion([usuarioActual])});
  ...
  Widget _buildContent(BuildContext context, Map<String, dynamic> data, arg) {
    ...
    unityWidgetController!.postMessage(
          ...
          "{ \"name\":\"initialize\",\"practice_type\":\"visualization\",\"lesson_name\":\"bubbleSort\",\"is_test\":false,\"array\":\"[12, 43, 12, 54, 22]\",\"hidden_animation\":\"items\"}",
        );
    }
    ...
    unityWidgetController!.postMessage(
                          'GameManager',
                          'OnFlutterMessageReceived',
                          "{\"name\":\"initialize\",\"practice_type\":\"visualization\",\"lesson_name\":\"selectionSort\",\"is_test\":false,\"array\":\"[12, 43, 12, 54, 22]\"}",
                        );
    }
    ...
    unityWidgetController!.postMessage(
                          'GameManager',
                          'OnFlutterMessageReceived',
                          "{\"name\":\"initialize\",\"practice_type\":\"visualization\",\"lesson_name\":\"insertionSort\",\"is_test\":false,\"array\":\"[12, 43, 12, 54, 22]\"}",
                        );
    }
                  },
                  fullscreen: false, 
                          ...
                          if (arg == 'NImip38OyNN166ISaFhK') {  //!KH99JvRZ9MOAo8DnnfLH - burbuja
                            ...
                            var usuarioActual = FirebaseFirestore.instance.collection('users').doc(FirebaseAuth.instance.currentUser?.uid ?? 'null');
                              ...
                              if (value.docs.isNotEmpty) {
                                ...
                                var challenge = value.docs[9]; 
                                var challenge2 = value.docs[10];
                                var challenge3 = value.docs[11];
                                var challenge4 = value.docs[12];
                                var challenge5 = value.docs[14];
                                FirebaseFirestore.instance.collection('challenges').doc(challenge.id).update({'lessonDone':FieldValue.arrayUnion([usuarioActual])});
                                
                                FirebaseFirestore.instance.collection('challenges').doc(challenge2.id).update({'lessonDone':FieldValue.arrayUnion([usuarioActual])});
                                FirebaseFirestore.instance.collection('challenges').doc(challenge3.id).update({'lessonDone':FieldValue.arrayUnion([usuarioActual])});
                                FirebaseFirestore.instance.collection('challenges').doc(challenge4.id).update({'lessonDone':FieldValue.arrayUnion([usuarioActual])});
                                FirebaseFirestore.instance.collection('challenges').doc(challenge5.id).update({'lessonDone':FieldValue.arrayUnion([usuarioActual])});
                              }
                            });  
                      if(unityWidgetController != null){
                        unityWidgetController!.postMessage(
                           ...
                           if (arg == 'MDJYvdWi0Xk67SD4YLTw') { //! wCYEbpCDc4uQR0qPSbkU - selección
                            ...
                            var usuarioActual = FirebaseFirestore.instance.collection('users').doc(FirebaseAuth.instance.currentUser?.uid ?? 'null');
                              ...
                              if (value.docs.isNotEmpty) {
                                ...
                                var challenge2 = value.docs[6];
                                var challenge3 = value.docs[13];
                                var challenge4 = value.docs[15];
                                var challenge5 = value.docs[18];
                                FirebaseFirestore.instance.collection('challenges').doc(challenge.id).update({'lessonDone':FieldValue.arrayUnion([usuarioActual])});
                                FirebaseFirestore.instance.collection('challenges').doc(challenge2.id).update({'lessonDone':FieldValue.arrayUnion([usuarioActual])});
                                FirebaseFirestore.instance.collection('challenges').doc(challenge3.id).update({'lessonDone':FieldValue.arrayUnion([usuarioActual])});
                                FirebaseFirestore.instance.collection('challenges').doc(challenge4.id).update({'lessonDone':FieldValue.arrayUnion([usuarioActual])});
                      ...
                      "{\"name\":\"dispose\"}",
                            ...
                            var usuarioActual = FirebaseFirestore.instance.collection('users').doc(FirebaseAuth.instance.currentUser?.uid ?? 'null');
                              ...
                              if (value.docs.isNotEmpty) {
                                ...
                                var challenge = value.docs[1];
                                var challenge2 = value.docs[4];
                                var challenge3 = value.docs[5];
                                var challenge4 = value.docs[16];
                                var challenge5 = value.docs[17];
           FirebaseFirestore.instance.collection('challenges').doc(challenge.id).update({'lessonDone':FieldValue.arrayUnion([usuarioActual])});
                                FirebaseFirestore.instance.collection('challenges').doc(challenge2.id).update({'lessonDone':FieldValue.arrayUnion([usuarioActual])});
                                FirebaseFirestore.instance.collection('challenges').doc(challenge3.id).update({'lessonDone':FieldValue.arrayUnion([usuarioActual])});
                                FirebaseFirestore.instance.collection('challenges').doc(challenge4.id).update({'lessonDone':FieldValue.arrayUnion([usuarioActual])});
...
if(unityWidgetController != null){
  ...
  void onUnityCreated(controller, args) {
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Container(
                  padding: EdgeInsets.symmetric(horizontal: 15).copyWith(bottom: 15, top: 15),
                  child: Text('Este algoritmo de ordenamiento consiste en comparar pares de elementos adyacentes en una lista y si están desordenanos intercambiarlos hasta que estén todos ordenados. Cada pasada a lo largo de la lista ubica el siguiente valor más grande en su lugar apropiado. En esencia, cada ítem “burbujea” hasta el lugar al que pertenece.', textAlign: TextAlign.justify, style: TextStyle(color: Colors.white,wordSpacing: 0.45, letterSpacing: 0.95, fontSize: 14, fontWeight: FontWeight.w600),),
                ),    
                Container(
                  padding: EdgeInsets.symmetric(horizontal: 15).copyWith(bottom: 15, top: 15),
                  child: Text('Al presionar el boton "DEMOSTRACIÓN", se te mostrará la primera pasada y segunda de un ordenamiento burbuja. Los ítems se comparan para ver si no están en orden. Si hay n ítems en la lista, entonces hay n − 1 parejas de ítems que deben compararse en la primera pasada. Es importante tener en cuenta que, una vez que el valor más grande de la lista es parte de una pareja, éste avanzará continuamente hasta que la pasada se complete.', textAlign: TextAlign.justify, style: TextStyle(color: Colors.white,wordSpacing: 0.45, letterSpacing: 0.95, fontSize: 14, fontWeight: FontWeight.w600),),
                ),              
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceAround,
                  children: [
